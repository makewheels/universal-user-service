...
JAR_NAME=${APP_HOME}/user-service/target/user-service-1.0.0.jar                     # jar包的名字
JAVA_OUT=${APP_HOME}/user-service/logs/start.log                                   #应用的启动日志

# 创建出相关目录
mkdir -p ${APP_HOME}
mkdir -p ${APP_HOME}/user-service/logs
usage() {
